java -jar /usr/local/lib/antlr-4.13.2-complete.jar -Dlanguage=Cpp C8086Lexer.g4
java -jar /usr/local/lib/antlr-4.13.2-complete.jar -Dlanguage=Cpp C8086Parser.g4
