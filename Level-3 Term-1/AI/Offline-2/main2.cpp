...
int GRASP(int vertices, vector<vector<int>> &edges, int max_iterations = 10)
{
    ...
    for (int i = 0; i < max_iterations; i++)
    {
        ...
        // Local Search
        max_cut_weight = LocalSearch(max_cut_graph, edges, cut_weight);
    }
...
//     // Set parameters
//     double alpha = 0.7; // Alpha for semi-greedy
//     int local_iterations = 100; // Reduced from 10 for faster execution
//     int grasp_iterations = 100; // Reduced from 10 for faster execution
...
//     // For faster testing, process only every 5th graph
//     for (int fileNum = 1; fileNum <= 54; fileNum ++) {
//         string filename = directory + "g" + to_string(fileNum) + ".rud";
//         ifstream file(filename);
...
//         // Run all algorithms for this graph
...
//         // 5. GRASP
//         int grasp_best = 0;
//         int grasp_result = 0; // Define grasp_result here
//         for (int i = 0; i < grasp_iterations; i++) {
//             int current_result = GRASP(vertices, edges, 1); // Single iteration of GRASP
//             grasp_best = max(grasp_best, current_result);
//             if (i == 0) grasp_result = current_result; // Store first result for chart
//         }
